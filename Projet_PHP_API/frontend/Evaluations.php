...
if (isset($_GET['id'])) {
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "http://localhost/R4.01-Projet_API/Projet_PHP_API/backendEvaluationsAPI.php?match_id=$match_id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ch = curl_init("http://localhost/R4.01-Projet_API/Projet_PHP_API/backend/EvaluationsAPI.php");
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
